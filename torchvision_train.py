...
if __name__=='__main__':
    ...
    file=open(args.out_dir+"/ parameter_file_ "+dt.datetime.now().strftime("%I:%M%p_%B_%d_%Y")+'.txt','w')
    file.write('model_name: '+str(args.model_name)+'\n')
    file.write('num classes: '+str(args.num_class)+'\n')
    file.write('batch size: '+str(args.bs)+'\n')
    file.write('learning rate: '+str(args.lr)+'\n')
    file.write('momentum: '+str(args.momentum)+'\n')
    file.write('input size: '+str(args.input_sz)+'\n')
    file.write('feat ext: '+str(args.feat_ext)+'\n')
    file.write('pretrain: '+str(args.pretrain)+'\n')
    file.write('Deconvolution: '+str(args.deconv)+'\n')
    file.close()
