...
class VisionBinary:
    ...
    def load_jpg_from_folder(self):
        ...
        tfms = get_transforms(flip_vert=True,max_rotate=45,max_warp=0.1,max_lighting = 0.1,p_lighting=0.5,p_affine=0.75)#, xtra_tfms=extralist)
